<?php
namespace HcbClientsTest\Service\Clients;

use HcbClients\Service\Clients\FetchQbBuilderService;
...
class FetchQbBuilderServiceTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->sortingService = $this->getMock('\HcBackend\Service\Sorting\SortingServiceInterface');
